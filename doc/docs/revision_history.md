...
| Date       | Description    |
|------------|----------------|
| January 2026   | - Renamed the Home page to [Get started](./index.md).<br/>- Removed the separate Installing the Cellular Monitor app page. This page is now a section of the Get started page. |
...
| January 2024 | Updated documentation for the Cellular Monitor app [v2.2.0](https://github.com/NordicSemiconductor/pc-nrfconnect-cellularmonitor/blob/main/Changelog.md). |
